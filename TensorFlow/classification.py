...
# label and split data # Create a column setting the Cammeo label to '1' and the Osmancik label to '0'
...
# Training data model to learn Parameters
...
# Traininf model using all available features
all_input_features = [
    'Eccentricity',
    'Major_Axis_Length',
    'Minor_Axis_Length',
